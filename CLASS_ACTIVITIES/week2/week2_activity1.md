...
public class TheaterSeating {
    public static void main(String[] args) {
        ...
        System.out.println("Available seats: " + availableSeats); // Should be 7
    }
}
```
</details>
...
public class TheaterSeating2D {
    public static void main(String[] args) {
        ...
        System.out.println("Theater Seating Chart (0=Available, 1=Booked):");
        // 4. Use nested loops to print the seating chart
        for (int i = 0; i < theater.length; i++) { // Iterates through rows
            for (int j = 0; j < theater[i].length; j++) { // Iterates through columns
                System.out.print(theater[i][j] + " ");
            }
            System.out.println(); // New line after each row is printed
        }
        ...
        System.out.println("Total booked seats: " + bookedSeats); // Should be 2
    }
}
```
</details>
